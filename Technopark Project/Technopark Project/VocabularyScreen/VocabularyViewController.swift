...
class VocabularyViewController: UIViewController {
    ...
    private lazy var vocabulary = Vocabulary(name: "Погода", progress: 12, succses: false, words: [Word(name: "A"), Word(name: "v")], learnedWords: [], misspelledWords: [], dateCreate: Date(), dateOfChange: Date(), numberOfAttempts: 0)//vocabulary: Vocabulary!
